...
public class SaveLatestLapTimeMultiplayerΙΙΙ : MonoBehaviour //  The latest lap time for PLAYER 2 will be saved and will be viewed by the player (TRACK 2) - Multiplayer
{
    ...
    void Update()
    {
        ...
        minutesCounter = PlayerPrefs.GetInt("MinSaveMultiplayer3");
        secondsCounter = PlayerPrefs.GetInt("SecSaveMultiplayer3");
        millisecondsCounter = PlayerPrefs.GetFloat("MilliSaveMultiplayer3");
