...
public class PositionCounter : MonoBehaviour // Cars' Positions Counter Mechanism/Checkpoint (This is what will be used) - Track 3
{
    ...
    IEnumerator Car1PlacementUI() // For Player 1 Car
    {
        ...
        if (lapsCount2.lapsNumber > lapsCount.lapsNumberMultiplayer) // If player 1 has completed more laps than player 2
        {
        ...
        if (lapsCount2.lapsNumber < lapsCount.lapsNumberMultiplayer) // If player 2 has completed more laps than player 1
        {
            car1PositionUI.SetActive(true);
            car2PositionUI.SetActive(true);
        ...
        if (lapsCount2.lapsNumber == lapsCount.lapsNumberMultiplayer) // If player 1 has completed the same laps like player 2
        {
    ...
    {
        yield return new WaitForSeconds(0.1f);
        if (lapsCount.lapsNumberMultiplayer > lapsCount2.lapsNumber) // If player 2 has completed more laps than player 1
        {
            car1PositionUI.SetActive(true);
            car2PositionUI.SetActive(true);
        ...
        if (lapsCount.lapsNumberMultiplayer < lapsCount2.lapsNumber) // If player 1 has completed more laps than player 2
        {
            car1PositionUI.SetActive(true);
            car2PositionUI.SetActive(true);
        ...
        if (lapsCount.lapsNumberMultiplayer == lapsCount2.lapsNumber) // If player 1 has completed the same laps like player 2
        {
            car1SameLapTexts.SetActive(true);
            car2SameLapTexts.SetActive(true);
        }
